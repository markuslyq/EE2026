...
HD_PWD='C:/Users/marku/Documents/EE2026/Lab/lab3/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alternating_blinking_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alternating_blinking_led.tcl
