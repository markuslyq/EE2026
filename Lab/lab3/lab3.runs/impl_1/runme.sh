...
HD_PWD='C:/Users/marku/Documents/EE2026/Lab/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alternating_blinking_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alternating_blinking_led.tcl -notrace
