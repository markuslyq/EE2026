...
HD_PWD='C:/Users/marku/Documents/EE2026/Lab/Lab4/Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log single_pulse_output.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source single_pulse_output.tcl -notrace
