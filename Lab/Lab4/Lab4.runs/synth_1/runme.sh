...
HD_PWD='C:/Users/marku/Documents/EE2026/Lab/Lab4/Lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_pulse_output.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_pulse_output.tcl
