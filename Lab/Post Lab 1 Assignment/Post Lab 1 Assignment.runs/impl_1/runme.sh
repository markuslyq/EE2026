...
HD_PWD='C:/Users/marku/Documents/EE2026/Post Lab 1 Assignment/Post Lab 1 Assignment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Matriculation_Number_Display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Matriculation_Number_Display.tcl -notrace
