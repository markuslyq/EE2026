...
HD_PWD='C:/Users/marku/Documents/EE2026/Post Lab 1 Assignment/Post Lab 1 Assignment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Matriculation_Number_Display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Matriculation_Number_Display.tcl
