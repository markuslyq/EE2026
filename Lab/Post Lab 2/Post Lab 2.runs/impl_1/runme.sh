...
HD_PWD='C:/Users/marku/Documents/EE2026/Lab/Post Lab 2/Post Lab 2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eight_bit_substractor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eight_bit_substractor.tcl -notrace
