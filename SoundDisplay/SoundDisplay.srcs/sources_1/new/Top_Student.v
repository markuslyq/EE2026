...
module Top_Student (
    ...
    assign display_mode = sw[1] ? 2'b01: 2'b00;
    ...
    if ( y == 62 && x >= 95 && x <= 191) begin oled_data <= 16'hF79E; end
    if ( y == 63 && x >= 0 && x <= 95) begin oled_data <= 16'hF79E; end
